...
class Product(models.Model):
    ...
    creatorProfile = models.ForeignKey(
        CreativeAccount, on_delete=models.CASCADE, null=True, blank=True)

    webAndMobile = models.ForeignKey(
        WebMobile, on_delete=models.CASCADE, null=True, blank=True)
    funitures = models.ForeignKey(
        Funitures, on_delete=models.CASCADE, null=True, blank=True)
    cobbling = models.ForeignKey(
        Cobbling, on_delete=models.CASCADE, null=True, blank=True)
